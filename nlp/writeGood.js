function weaselWords(text, opts) {
    var weasels = [
        'are a number',
        'clearly',
        'completely',
...
function passiveVoice(text, options) {
    ...
    //  lol
    const constructByRe = () => byRe = new RegExp(re.toString().slice(1, -3) + '\\s*by\\b', 'gi');
